...
CREATE TABLE IF NOT EXISTS ai_programmes (
  ...
  statut                  text NOT NULL DEFAULT 'en_attente'
                          CHECK (statut IN ('en_attente', 'valide', 'publie')),
...
-- Coach voit tout, peut tout modifier
...
-- Cliente voit uniquement si statut = 'publie'
...
-- ══════════════════════════════════════════════
--  Ajouts à tables existantes
-- ══════════════════════════════════════════════

-- Réponses aux questions personnalisées dans les bilans
ALTER TABLE bilans
  ADD COLUMN IF NOT EXISTS reponses_personnalisees jsonb;

-- Flag de soumission du questionnaire
